...
export default function useTodos() {
    ...
    // Calculate stats directly from todos
    const stats = useMemo(() => {
    ...
    const toggleDone = async (id) => {
        ...
        const todoToUpdate = todos.find(t => t._id === id || t.id === id);
        if (!todoToUpdate) {
            return { success: false, message: "Todo not found" };
        }

        const currentStatus = todoToUpdate.isDone;
        ...
        try {
            ...
            // Optional: Refresh the todo from API to ensure sync
    ...
    return {
        ...
        allTodos: todos, // return all todos for stats
        stats,
        loading,
        error,
        filterDone,
