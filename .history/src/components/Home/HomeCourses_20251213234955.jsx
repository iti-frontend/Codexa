...
const benefits = [
  {
    icon: Award,
    titleKey: "home.course.benefits.expertCourses.title",
    descKey: "home.benefits.expertCourses.desc",
    color: "from-blue-500/10 to-blue-500/5",
    iconColor: "text-blue-500",
  },
  {
    icon: Video,
    titleKey: "home.benefits.highQuality.title",
    descKey: "home.benefits.highQuality.desc",
    color: "from-purple-500/10 to-purple-500/5",
    iconColor: "text-purple-500",
  },
  {
    icon: Users,
    titleKey: "home.benefits.activeCommunity.title",
    descKey: "home.benefits.activeCommunity.desc",
    color: "from-green-500/10 to-green-500/5",
    iconColor: "text-green-500",
  },
  {
    icon: TrendingUp,
    titleKey: "home.benefits.trackProgress.title",
    descKey: "home.benefits.trackProgress.desc",
    color: "from-orange-500/10 to-orange-500/5",
    iconColor: "text-orange-500",
  },
  {
    icon: BookOpen,
    titleKey: "home.benefits.lifetimeAccess.title",
    descKey: "home.benefits.lifetimeAccess.desc",
    color: "from-pink-500/10 to-pink-500/5",
    iconColor: "text-pink-500",
  },
  {
    icon: MessageSquare,
    titleKey: "home.benefits.directSupport.title",
