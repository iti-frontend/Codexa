...
export function CommentSection({ post }) {
    ...
    // دالة محسنة لاستخراج اسم صاحب الكومنت
    const getAuthorName = (comment) => {
        if (!comment.author) {
            return "Anonymous";
        }

        // إذا كان المؤلف كائن وبه اسم
        if (typeof comment.author === 'object') {
            if (comment.author.name && comment.author.name !== "Anonymous") {
        ...
        // إذا كان الكومنت للمستخدم الحالي
                            ...
                            <div className="flex-1 space-y-1">
                                <div className="bg-secondary rounded-lg p-3">
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        {/* أزرار التحكم - باستخدام DropdownMenu */}
                                        {isMyComment && (
                                            <DropdownMenu>
