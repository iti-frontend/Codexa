...
export function PostCard({ post, onLike }) {
  ...
  // التحقق إذا كان المستخدم الحالي معجب بالمنشور - FIXED
  ...
  // دالة لاستخراج اسم المستخدم - FIXED
  ...
  // التحقق إذا كان المنشور ملك للمستخدم الحالي - FIXED
  const isPostOwner = () => {
    ...
    <Card className="border-border">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          {/* القائمة المنسدلة للتحكم في البوست - FIXED */}
          {isPostOwner() && (
            <DropdownMenu>
