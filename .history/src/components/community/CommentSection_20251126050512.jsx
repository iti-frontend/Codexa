...
export function CommentSection({ post }) {
  ...
  const postId = post._id; // استخدم post._id مباشرة
  ...
  const getUserName = (comment) => {
    if (!comment.author && !comment.user) return user?.name || "Anonymous";
  ...
  const isCommentOwner = (comment) => {
    ...
    return author._id === user._id || author.id === user._id || author.userId === user.uid;
  };
