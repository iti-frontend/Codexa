...
export function PostCard({ post }) {
  ...
  const isOwner = (() => {
    ...
    const authorId =
      typeof post.author === "string" ? post.author : post.author._id || post.author.id;
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="z-50">
                  {isOwner ? (
                    ...
                    <DropdownMenuItem disabled>Not your post</DropdownMenuItem>
                  )}
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
