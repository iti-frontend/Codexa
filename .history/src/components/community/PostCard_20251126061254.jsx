...
export function PostCard({ post }) {
  ...
  const isPostOwner = () => {
    ...
    console.log("🔍 Owner Check:", { authorId, userId, isOwner: authorId === userId });
  ...
  const isLiked = () => {
    ...
    console.log("❤️ Like Status:", { userId, localLikes, liked });
    return liked;
  };

  const getAuthorName = () => {
    if (!post.author) {
      console.log("⚠️ No author in post");
      return "Anonymous";
    }
    
    if (typeof post.author === 'object' && post.author.name) {
      console.log("✅ Author name from post:", post.author.name);
      return post.author.name;
    }
    
    if (isPostOwner() && userInfo?.name) {
      console.log("✅ Author name from userInfo:", userInfo.name);
      return userInfo.name;
    }
    
    console.log("⚠️ Fallback to Anonymous");
    return "Anonymous";
  };
