...
export function PostCard({ post }) {
  ...
  // جزء اللايك المطلوب فقط - تم التعديل هنا
  const isLiked = post.likes?.some(like => like.userId === userInfo?.uid);
...
}  لما بضغط علىإضافة كومنت بيجيب الرسالة دى Cast to ObjectId failed for value "undefined" (type string) at path "_id" for model "CommunityPost"