      ...
      <div>
        ...
        <div className="flex flex-col  sm:flex-row items-center gap-4">
          ...
          <input
            ...
            className="text-gray-200 file:mx-4 file:py-2 file:px-4 file:rounded-md file:border file:border-gray-400 file:bg-primary file:text-white hover:file:bg-primary-500 cursor-pointer"
          />
        </div>
      </div>
