...
export default function ProfileCard({ profile, editLink }) {
  ...
  return (
    <div className="min-h-screen py-10 px-4 bg-[#0d1117]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-20 px-4">
          ...
          >
            ...
            <Link
              href={editLink}
              className="w-full sm:w-auto px-4 py-2 sm:px-5 sm:py-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition"
            >
              Edit Profile
            </Link>
          </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {profile.links.map((link, i) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600/20 rounded-full flex items-center justify-center">
