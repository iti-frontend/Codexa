...
<div className="min-h-screen py-8 px-4">
  <div className="max-w-3xl mx-auto bg-[#161b22] rounded-xl p-6 sm:p-8 shadow-md">
    <h1 className="text-3xl text-white font-bold mb-6 text-center sm:text-left">Edit Profile</h1>
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Profile Image */}
      <div>
        <label className="block text-gray-200 mb-2">Profile Image</label>
        <div className="flex flex-col justify-ce sm:flex-row items-center gap-4">
          {imagePreview && (
            <img
              src={imagePreview}
              alt="Preview"
          ...
          <input
            ...
            className="text-gray-200 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border file:border-gray-400 file:bg-indigo-600 file:text-white hover:file:bg-indigo-700 cursor-pointer"
          />
        </div>
      </div>
