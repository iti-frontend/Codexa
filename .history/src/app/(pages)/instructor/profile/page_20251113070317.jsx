            ...
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_API_BASE_URL}/instructors/profile`,
                {
                    ...
                    headers: {
                        ...
                        // Don't add Content-Type manually – the browser sets it automatically for FormData
                    },
                    body: data,
                }
            );
                ...
                if (contentType && contentType.includes("application/json")) {
                    ...
                    if (updatedProfile) {
                        ...
                        if (userInfoCookie) {
                            ...
                            userInfo.links =
                                updatedProfile.links || userInfo.links;
                    ...
                    setMessage(
                        "✅ Profile saved (server response not confirmed)"
                    );
                }
            } else {
                const text = await res.text();
                        ...
                        {formData.links.map((link, index) => (
                            <div key={index} className="flex gap-2 mb-3">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 text-black border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                                />
                                <input
                                    type="url"
                                    ...
                                    className="flex-1 px-4 text-black py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                                />
                                <button
                                    type="button"
