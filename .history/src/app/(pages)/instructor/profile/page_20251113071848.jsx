...
export default function InstructorProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("Has Image:", !!formData.profileImage);
            ...
            if (res.ok) {
                ...
                try {
                    ...
                    setMessage(`❌ Error ${res.status}: Failed to update profile. Check console for details.`);
                }
            }
        } catch (error) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 text-gray-700 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        {formData.links.map((link, index) => (
                            <div key={index} className="flex gap-2 mb-3">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 text-gray-700 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                                />
                                <input
                                    type="url"
