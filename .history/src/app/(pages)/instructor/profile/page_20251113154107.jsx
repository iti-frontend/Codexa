            ...
            if (res.ok) {
                ...
                try {
                    ...
                    if (userInfoCookie) {
                        ...
                        if (requestData.name) userInfo.name = requestData.name;
                        if (requestData.bio !== undefined) userInfo.bio = requestData.bio;
                        if (requestData.links) userInfo.links = requestData.links;
                        if (requestData.profileImage) userInfo.profileImage = requestData.profileImage;
                ...
                setTimeout(() => {
                    window.location.href = "/instructor/profile/view";
                }, 1500);
            } else {
                ...
                try {
                    ...
                    setMessage(`❌ Error ${res.status}: Failed to update profile.`);
                }
            }
        } catch (error) {
