        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-400 rounded-md bg-gray-50 text-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            ...
            {formData.links.map((link, index) => (
              <div key={index} className="flex gap-2 mb-3">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-400 rounded-md bg-gray-50 focus:ring-2 focus:ring-blue-500"
                />
                <input
                  type="url"
