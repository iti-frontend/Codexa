...
>
  {/* أيقونة */}
  <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-indigo-600/20 rounded-full flex items-center justify-center">
    <Globe size={1} className="text-indigo-400" />
  </div>
