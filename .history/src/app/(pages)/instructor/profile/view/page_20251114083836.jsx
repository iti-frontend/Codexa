...
export default function ProfileView() {
    ...
    return (
        <div className="min-h-screen bg-[#0d1117] py-10 px-4 text-gray-200">
            <div className="max-w-5xl mx-auto">
                ...
                >
                    <motion.img
                        ...
                        className="absolute -bottom-16 left-6 w-32 h-32 rounded-full border-4 border-[#0d1117] shadow-xl object-cover"
                    />
                </motion.div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {profile.links.map((link, i) => (
                                    <motion.a
                                        ...
                                        href={link.url}
                                        target="_blank"
                                        className="group p-4 bg-[#1f242d] border border-gray-700 rounded-xl hover:border-indigo-500 transition flex items-center gap-3 sm:gap-4"
                                    >
                                        {/* أيقونة أصغر */}
                                        <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600/25 rounded-full flex items-center justify-center">
                                            <Globe size={18} className="text-indigo-400" />
                                        </div>

                                        {/* نص اللينك */}
                                        <div className="flex-1 min-w-0">
                                            <p className="font-medium text-gray-200 truncate group-hover:text-indigo-400 transition">
                                                {link.label}
                                            </p>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
                            ...
                            <div>
                                ...
                                <p
                                    className={`font-medium ${profile.isActive ? "text-green-400" : "text-red-500"
                                        }`}
                                >
