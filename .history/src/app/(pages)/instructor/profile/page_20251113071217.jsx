        ...
        try {
            ...
            if (res.ok) {
                if (contentType && contentType.includes("application/json")) {
                    ...
                    setMessage("✅ Saved (without confirmation from server)");
                }
            } else {
                const text = await res.text();
                ...
                try {
                    ...
                    setMessage(`❌ Error ${res.status}: Failed to update. Check console for details.`);
                }
            }
        } catch (error) {
                        ...
                        <div className="flex items-center gap-4">
                            {imagePreview && (
                                <img
                                    src={imagePreview}
                                    alt="Preview"
                                    className="w-16 h-24 rounded-full object-cover border-2 border-gray-300"
                                />
                            )}
                            <input
                                type="file"
