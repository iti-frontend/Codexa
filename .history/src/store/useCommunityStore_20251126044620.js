...
export const useCommunityStore = create((set, get) => ({
    ...
    // Fetch all posts
// في useCommunityStore.js - تأكد من هذه الدوال
// Fetch all posts - تأكد من معالجة البيانات بشكل صحيح
fetchPosts: async () => {
    set({ loading: true, error: null });
    try {
        const res = await api.get("/community");
        console.log("✅ Fetched posts raw:", res.data);
        ...
        // تأكد من وجود بيانات المستخدم في كل منشور وكل كومنت
