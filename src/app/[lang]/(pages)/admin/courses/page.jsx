...
export default function AdminCoursesPage() {
  ...
  const handleScroll = (e) => {
    ...
    if (bottom) {
      setVisibleCount((prev) => Math.min(prev + 6, filteredCourses.length));
    }
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {!loading && !error && filteredCourses.length > 0 && (
        <div className="h-[70vh] overflow-y-auto pr-2" onScroll={handleScroll}>
              ...
              >
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="text-sm text-muted-foreground flex justify-between pt-2">
                    <span>
                      {t("admin.courses.price")}: {course.price}$
                    </span>
